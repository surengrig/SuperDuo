        ...
        try {
            ...
            for (int i = 0; i < matches.length(); i++) {
                ...
                if (league.equals(PREMIER_LEAGUE) ||
                    ...
                    match_values.put(DatabaseContract.ScoresEntry.COLUMN_MATCH_ID, matchId);
                    match_values.put(DatabaseContract.ScoresEntry.COLUMN_DATE, date);
                    match_values.put(DatabaseContract.ScoresEntry.COLUMN_TIME, time);
                    match_values.put(DatabaseContract.ScoresEntry.COLUMN_HOME, home);
                    match_values.put(DatabaseContract.ScoresEntry.COLUMN_AWAY, away);
                    match_values.put(DatabaseContract.ScoresEntry.COLUMN_HOME_GOALS, homeGoals);
                    match_values.put(DatabaseContract.ScoresEntry.COLUMN_AWAY_GOALS, awayGoals);
                    match_values.put(DatabaseContract.ScoresEntry.COLUMN_LEAGUE, league);
                    match_values.put(DatabaseContract.ScoresEntry.COLUMN_MATCH_DAY, matchDay);
                    //log spam
            ...
            insertedCount = mContext.getContentResolver().bulkInsert(
