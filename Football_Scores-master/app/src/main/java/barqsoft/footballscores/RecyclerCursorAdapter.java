...
/**
 * RecyclerView.Adapter with added CursorAdapter implementation.
 *
 */
public abstract class RecyclerCursorAdapter<VH extends RecyclerView.ViewHolder> extends
    ...
    public VH onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (mCursor.moveToPosition(i)) {
            return onCreateViewHolder(viewGroup, mCursor);
        } else {
            throw new IndexOutOfBoundsException();
        }
    }

    abstract public VH onCreateViewHolder(ViewGroup viewGroup, Cursor cursor);
