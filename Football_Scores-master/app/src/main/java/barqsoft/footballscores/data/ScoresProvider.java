...
public class ScoresProvider extends ContentProvider {
    ...
    private static final String SCORES_BY_LEAGUE = DatabaseContract.ScoresEntry.COLUMN_LEAGUE + " = ?";
    private static final String SCORES_BY_DATE = DatabaseContract.ScoresEntry.COLUMN_DATE + " LIKE ?";
    private static final String SCORES_BY_ID = DatabaseContract.ScoresEntry.COLUMN_MATCH_ID + " = ?";
